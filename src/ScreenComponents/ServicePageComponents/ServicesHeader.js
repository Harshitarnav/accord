    ...
    return (
        <div className="relative max-w-7xl mx-auto py-12 px-4">
            <div className="text-center">
                ...
                <p className="mt-3 mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            ...
            <div className="flex flex-wrap justify-between text-2xl font-bold text-gray-600 mt-10">
                {features.map((feature, index) => (
                    <div key={index} className="w-full sm:w-1/2 lg:w-1/3 py-2 text-center">
                        <p className="mb-4 text-sm">{feature.name}</p>
